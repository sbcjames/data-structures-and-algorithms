...
const mapCurrentEvents = () => {
  return currentEvents.news.map(value => new Event(value.author, value.category, value.description, value.url, value.published, value.title));
};

function Event(author, category, summary, url, date, time){
  this.author = author;
...
const reversedString = (str) => {
  ...
  const reversedString = letters.reduce((reversed, string) => {
